# -*- coding: utf-8 -*-
"""
Created on Sat Nov  5 14:28:15 2022
...
for i in range( len(Unqs)):
    ...
    try:
        ...
        bnrymask = np.zeros(Sz , dtype=int)
        ...
        for j in range(len(indices)):
            ...
            croped_img = Img[min_slc:max_slc, min_col:max_col, min_row:max_row]
        ...
        pt_dcmwrt = Path(pt.replace('.dcm', '_mask.dcm' ))
